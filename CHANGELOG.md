...
- **Backend dependencies** — Updated backend libraries to their latest compatible (non-breaking) versions: Ktor 2.3.6 → 2.3.13, Kotlin 1.9.20 → 1.9.25, Logback 1.4.11 → 1.5.38, PostgreSQL driver 42.7.1 → 42.7.13, Micrometer 1.11.0 → 1.12.4 (aligned with Ktor's bundled core), Testcontainers 1.21.3 → 1.21.4, JUnit Jupiter 5.10.1 → 5.10.5, and mockito-kotlin 5.2.1 → 5.4.0
